...
| TVS Next | https://tvsnext.keka.com/careers/ | Keka Hire | `GET https://tvsnext.keka.com/careers/api/jobs/default/active`; detail `GET https://tvsnext.keka.com/careers/jobdetails/{id}` | India-only board; `jobLocations[].countryName == "India"` | 17 | ✅ DIRECT ENDPOINT VALIDATED 2026-07-21 — public Keka JSON returns active jobs with title, HTML JD, department, and locations; sample detail `jobdetails/133093` works cookie-free with full JD; provider wiring pending |
